...
ACTOR_LR            = 1e-4     # Learning rate for the actor (policy) network
CRITIC_LR           = 1e-4     # Learning rate for the critic (Q-value) networks
ALPHA_LR            = 1e-4     # Learning rate for entropy coefficient α
